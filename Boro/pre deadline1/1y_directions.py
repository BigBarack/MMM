...
def analytical_solution(sim_ob):
    ...
    for obs in sim_ob.observation_points.values():
        ...
        k= 2 * np.pi / sim_ob.lmin  # Wavevector (k) based on the wavelength
        a = None
        ...
        axH.plot(k, Hz_scat_values, label="|Hz_scat|")  # Plot on the Axes
        ...
        print(Hz_scat_values)

frequency_analysis(sim)
analytical_solution(sim_ob=sim)
# sim.debugger(show_grid=True, field='Hz')